# change ckpt_dir and patch_size
...
parser.add_argument('--patch_size', type=int, default=200, help='patchsize of input.')
...
parser.add_argument("--ckpt_dir",type=str,default="train_ckpt/v8",help = "Name of the Directory where the checkpoint is to be saved")
