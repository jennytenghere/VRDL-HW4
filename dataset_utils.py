...
class TrainDataset(Dataset):
    def __init__(self, args):
        ...
        root_dir = "../hw4_realse_dataset/train"
        ...
        self.clean_images = sorted([
            f for f in os.listdir(self.clean_dir) if f.endswith('.png')
        ])
    ...
    def __getitem__(self, idx):
        clean_name = self.clean_images[idx]
        degraded_name = clean_name.replace("_clean", "")

        if "snow" in clean_name:
            de_id = 0
        else:
            de_id = 1
...
class TestDataset(Dataset):
    def __init__(self, args):
        ...
        self.root_dir = "../hw4_realse_dataset/test/degraded"
        self.images = sorted([
    ...
    def __getitem__(self, idx):
        degraded_path = os.path.join(self.root_dir, self.images[idx])
        ...
        # print("name: ",degraded_path, degraded_name)
